...
import PasscodeGate from './components/PasscodeGate.vue';

const isAuthorized = ref(localStorage.getItem('monthsary_auth') === 'true');
...
<template>
  <div class="min-h-screen bg-brown-50 transition-colors duration-1000 font-sans selection:bg-brown-200 selection:text-brown-900">
    <Transition name="fade">
      <PasscodeGate v-if="!isAuthorized" @authorized="handleAuthorized" />
      <div v-else>
        <FloatingBackground />
        <!-- Hero Section -->
